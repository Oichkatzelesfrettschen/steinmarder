...
# $env:SM_DISABLE_360="1"
# $env:SM_DISABLE_WRITE_PNG="1"
# $env:SM_DISABLE_POSTFX="1"
...
for ($i=0; $i -lt $Runs; $i++) {
  ...
  # $env:SM_SCENE = (Resolve-Path $scene).Path

  # Eğer scene loader arg alıyorsa (ör: .\steinmarder.exe -scene path):
