// file: sm_ipc_v1_4.y
// steinmarder OS — Canonical IPC Spec v1.4
...
func setup_gpu_portal(rb: *RingBuffer<f32, 1024>) {
    chisel {
        ...
        print("steinmarder IPC: GPU portal established. WC data, WB indices.");
    }
}
...
// GPU consumer path is handled by DMA — see sm_gpu_consumer.cu
...
//   steinmarder fix: per-core ring buffers + work-stealing consumer (v2.0 target).
//
