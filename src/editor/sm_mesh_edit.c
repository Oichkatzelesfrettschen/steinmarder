// sm_mesh_edit.c
// steinmarder Mesh Edit 2.0 - Single File Mini Blender-Style Editor
 ...
 * - `sm_mesh_edit.c` is a single-file immediate-mode editor with fixed limits:
...
#define SM_MAX_EDGES  (MAX_TRIS * 3)
                     ...
                     EditTri *tris,   int triCount)
{
    ...
    fprintf(f, "# Exported from steinmarder Mesh Edit\n");
...
int main(void)
{
    ...
    InitWindow(W, H, "steinmarder Mesh Edit 2.0");
    SetTargetFPS(60);
...
// =====================================================
        ...
        if (uiMode == MODE_EDIT) {
            DrawText("steinmarder Mesh Edit 2.0 (EDIT MODE)",            10, 10, 20, RAYWHITE);
            ...
            DrawText("steinmarder Viewport (OBJECT MODE)",               10, 10, 20, RAYWHITE);
            DrawText("F1=Edit, F2=Viewport",                     10, 34, 16, RAYWHITE);
            DrawText("ALT+LMB orbit, wheel zoom",                10, 54, 16, RAYWHITE);
