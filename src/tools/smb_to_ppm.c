// smb_to_ppm.c - convert SMB_ float32 buffer to PPM (for quick inspection)
#include <stdio.h>
#include <stdint.h>
#include <stdlib.h>
#include <math.h>
...
int main(int argc, char** argv){
    const char* in  = (argc > 1) ? argv[1] : "output_color.smb";
    const char* out = (argc > 2) ? argv[2] : "smb_preview.ppm";
    ...
    if(h.magic[0]!='S'||h.magic[1]!='M'||h.magic[2]!='B'||h.magic[3]!='_'){ printf("not SMB_\n"); return 1; }
