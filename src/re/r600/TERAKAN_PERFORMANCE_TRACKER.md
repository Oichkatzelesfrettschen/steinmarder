...
- **Desktop build workflow**: Build on DESKTOP-CKP9KB6 (32 cores, ~40s),
  rsync to x130e
- **LTO is counterproductive** on E-300: clang's aggressive inlining bloats
  .text beyond L1i capacity
...
- **Load average** dominates FPS variation — same build ranges 120-301 FPS
  depending on load
...
**FAILED**: Zink requires DRI3/VK_KHR_swapchain which Terakan doesn't support
yet.
...
| Sequential dispatch          | FAIL        | Second kernel reads stale data from first output     |
