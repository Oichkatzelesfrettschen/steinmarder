...
\author{%
  steinmarder contributors
  \\[4pt]
  \normalsize\textit{steinmarder Project}
}
\date{March 2026}
...
\input{fig_multidim_table.tex}

\section{Pipeline Architecture}
\label{fig:pipeline}
\input{fig_pipeline_stages.tex}

\section{Instruction Taxonomy}
\input{fig_instruction_taxonomy.tex}

\input{lions_commentary.tex}
