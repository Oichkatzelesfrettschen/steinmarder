...
**Measured**: 2026-04-02/03 via steinmarder dep-chain probe harnesses  
...
| RECIP (reciprocal) | dep-chain | **8.605** | ~11 | Special unit; ~4× fadd; philip: 6-cycle TP |
| RSQRT (reciprocal sqrt) | dep-chain | **9.405** | ~12 | Special unit; ~1 cycle deeper than RECIP |
...
| RECIP (8-acc TP) | **6.269** | 1.37× (vs dep) | ~8/op | Needs wider chain to saturate; philip: 6-cycle TP |
| RSQRT (8-acc TP) | **9.393** | 1.00× (= dep!) | ~12/op | Self-loop serialization bug — probe needs redesign |
...
| RECIP32: 6-cycle throughput; RSQRT32: 8-cycle throughput | philipturner |
