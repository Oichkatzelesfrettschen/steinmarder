...
| r600 / TeraScale-2 | AMD Radeon HD 6310 Evergreen VLIW5 RE, Mesa 26 driver optimization, Terakan Vulkan | [`FRONTIER_ROADMAP_R600_TERASCALE.md`](FRONTIER_ROADMAP_R600_TERASCALE.md), `~/eric/TerakanMesa/findings/` | `R600_DEBUG`, `GALLIUM_HUD`, `AMDuProfCLI`, `radeontop`, `apitrace`, `perf`, `gdb` | ISA slot analysis, pipeline utilization, stutter RCA, numeric packing research, 426-opcode inventory | active |
