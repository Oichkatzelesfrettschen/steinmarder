# steinmarder Neural Upscale — DLSS-class Temporal Super-Resolution Architecture
...
Expose env var `SM_UPSCALE_DEBUG`:
...
- `sm_upscale.h` — public API
- `sm_upscale.c` — Vulkan resource management and dispatch
