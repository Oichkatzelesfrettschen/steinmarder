...
- [`../src/apple_re/results/blessed/2026-03-30_tranche1_r7_cde_keepalive/gpu_hardware_counters.md`](../src/apple_re/results/blessed/2026-03-30_tranche1_r7_cde_keepalive/gpu_hardware_counters.md) -- **First hardware GPU counter capture**: ALU 79% peak (balanced), Fragment Occupancy 100% (M1 TBDR compute), host dispatch bottleneck quantified at 1.6% avg ALU
